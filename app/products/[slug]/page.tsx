...
// NEW: Tabby banner (client component)
import TabbyBanner from "@/app/components/TabbyBanner";
      ...
      <div className={s.grid}>
        ...
        <aside className={s.right}>
          <div className={s.sticky}>
            ...
            {/* Financing banner (no DB needed) */}
            <TabbyBanner price={product.price} currency="AED" sku={product.sku} />
