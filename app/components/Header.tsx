...
//   return (
//     <header className={styles.wrap} onKeyDown={(e) => e.key === "Escape" && setMega(null)}>
//       {/* ============== MOBILE TOP ROW ============== */}
...
//         {/* HOVER ZONE: wraps nav + mega (keeps menu open when moving between them) */}
...
//                     // ⛔ removed onMouseLeave on each <li>
//                   >
//                     <Link
//                       href={item.href}
...
//           {/* Mega panel in the SAME hover zone */}
...
//               <circle cx="12" cy="8" r="3.5" /><path d="M4 20c2.5-4.5 13.5-4.5 16 0" />
//             </svg>
//             <span>Account</span>
//           </Link>
